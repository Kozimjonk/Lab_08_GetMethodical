...
public class BirthDateTime
{
    public static void main(String[] args)
    {
        ...
        int birthHour = 0;
        int birthMinute = 0;
        birthYear = SafeInput.getRangedInt(in, "Enter birth year [1900-2015]:", 1900, 2015);
        ...
        birthMinute = SafeInput.getRangedInt(in, "Enter your birth minute [1-59]", 1, 59);
        System.out.println("You we born on " + birthMonth + "/" + birthDay + "/" + birthYear + " at " + birthHour + ":" + birthMinute );
